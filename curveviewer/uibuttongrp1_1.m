function handle = uibuttongrp1_1(varargin)

%ML 2012
% handle = uibuttongrp1_1(propertyname, propertyvalue,...)
% generates a uibuttongroup object by attribuating propertyvalues to
% propertynames.
% availabe properties are all uibuttongroup properties, 
% see uibuttongroup properties in Matlab documentation
...
function handle = makebuttongrp(h)

    handle = uibuttongroup('parent',h.parent);%
    f = fieldnames(h);
